(()=>{
'use strict';
const VERSION='1.9.12-spaced-readable-sidebars';
window.DaGoPreloadSidebarDensityFix={version:VERSION,columnsPerTrack:4};
...
function apply(){
  document.querySelectorAll('.dago-vertical-track').forEach(track=>{
    ...
    cols.forEach((col,i)=>{ if(i>=4) col.remove(); });
  });
}
apply();
