...
const MAP=new Map([
 ...
 ['appearance','相貌'],['resource','資源'],['wealth','財富'],['court','官場'],['jianghu','江湖'],['geo','地理'],['nature','自然'],['history','歷史'],['religion','宗教'],['study','學藝'],['will','意志'],['language','語言'],['social','交際'],['empathy','共情'],['speech','口才'],
 ...
 ['morning','晨時'],['noon','午時'],['dusk','昏時'],['night','夜時'],
 ['trust','信任'],['favor','好感'],['fear','畏懼'],['anger','怒意']
]);
...
function replaceOne(text){
  ...
  for(const [from,to] of MAP){
    out=out.replace(new RegExp(`(^|[^A-Za-z_])${from}(?=\\\\s|:|：|$|[^A-Za-z_])`,'g'),`$1${to}`);
  }
