(()=>{
'use strict';
const VERSION='1.12.8-panel-enhance';
...
const scripts=['assets/scenario-select.js','assets/game-bundle-loader.js','assets/engine/state.js','assets/engine/rules.js','assets/engine/checks.js','assets/engine/effects.js','assets/engine/passage.js','assets/engine/save.js','assets/engine/export-playlog.js','assets/game-v6-hotfix.js','assets/character-create-ui.js','assets/game-rules-ui-fix.js','assets/game-character-balance-fix.js','assets/game-modular.js','assets/panel-enhance-v127.js'];
...
(async()=>{for(const src of scripts)await add(src);document.body.classList.add('dago-ready','dago-modular-ready','dago-full-ui-ready','dago-panel-enhance-ready')})();
})();
