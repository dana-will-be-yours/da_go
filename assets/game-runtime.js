(()=>{
'use strict';
const VERSION='1.12.9-modular-panels';
...
(async()=>{for(const src of scripts)await add(src);document.body.classList.add('dago-ready','dago-modular-ready','dago-full-ui-ready','dago-modular-panels-ready')})();
})();
