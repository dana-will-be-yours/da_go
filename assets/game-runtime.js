...
(async()=>{for(const src of scripts)await add(src);document.body.classList.add('dago-ready','dago-modular-ready','dago-full-ui-ready','dago-direct-split-ready')})();
})();
