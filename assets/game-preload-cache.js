(()=>{
'use strict';
const VERSION='1.9.9-continuous-edge-safe-sidebars';
...
function makeColumn(seed){let parts=[];for(let i=0;i<6;i++)parts=parts.concat(shuffle(seed));return parts.join('　')}
function makeTrack(seed){let html='';for(let i=0;i<7;i++)html+='<span class="dago-vcol">'+esc(makeColumn(shuffle(seed)))+'</span>';return html}
