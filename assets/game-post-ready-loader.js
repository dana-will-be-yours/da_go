...
const SCRIPTS=[
  'assets/preload-sidebar-density-fix.js?v=1.10.11-role-rank-table',
  'assets/scenario-select.js?v=1.10.11-role-rank-table',
  'assets/game-rules-ui-fix.js?v=1.10.11-role-rank-table',
  'assets/game-character-balance-fix.js?v=1.10.11-role-rank-table'
];
