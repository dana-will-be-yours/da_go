...
const SCRIPTS=[
  'assets/preload-sidebar-density-fix.js?v=1.11.0-changshan-year',
  'assets/scenario-select.js?v=1.11.0-changshan-year',
  'assets/game-rules-ui-fix.js?v=1.11.0-changshan-year',
  'assets/game-character-balance-fix.js?v=1.11.0-changshan-year'
];
